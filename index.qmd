...
document.querySelector("div[data-fig-label='nn_fit_holder'] img").style = "width: 80%"
}</script>
...
## Introducing _Name to be decided_ {.center}
...
## Attention is all you need, but did we need that much attention?{.smaller}

<!-- *   Modern Transformers have billions of parameters, holding vast world knowledge. -->
<!--     *   **Motivating Question:** Can we study simpler models to understand the fundamental computational circuits underlying reasoning  -->
...
<!--     *   [@elhage2022toy] showed how Sparse Autoencoders (SAEs) disentangle overlapping concepts, leading to more interpretable  -->
<!-- representations. -->
...
<!--     *   **Gap to Fill:** Lack of simultaneous visualization of training dynamics *and* circuit structure – particularly crucial in  -->
...
::::{.columns}
:::{.column width=50%}
![Toy Transformer Models](imgs/basic_schematic.png)
:::
:::{.column width=50%}
![Training Dynamics in Toy Models of Superimposition](imgs/tmos-img.png)
:::
::::
